...
public class AdminBorrowInfo extends JDialog {
	...
	public void getData(){
		...
		ArrayList<BorrowInfo> borrowInfos= borrowInfoDAO.getAll();
	...
	public AdminBorrowInfo(int id) {
		...
		JLabel lblNewLabel = new JLabel("\u501F\u4E66\u4FE1\u606F");
		...
		btnNewButton = new JButton("\u67E5\u770B\u501F\u4E66\u4FE1\u606F");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				GetBorrowInfo getBorrowInfo = new GetBorrowInfo(borrowId);
				getBorrowInfo.setVisible(true);
			}
		});
